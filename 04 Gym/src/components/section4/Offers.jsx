  ...
  return (
    <div id="offers" className={styles.mainContainerOffers}>
      ...
      <div className={styles.containerOffers}>
        ...
        <div className={styles.containerSmallerOffers}>
          <div>
            <GiWeightLiftingUp size={40} color="var(--color-orange-light)" />
          </div>
          <div>
            <h4>Body Building Programs</h4>
            <p>
              Unlock your potential with our comprehensive bodybuilding program.
              Sculpt, strengthen, and achieve greatness!
            </p>
          </div>
        </div>
